...
input_file = "data/raw/consumo_turistico_inegi.csv"
output_file = "data/processed/consumo_turistico_inegi_clean.csv"
...
# Reordenar columnas (manteniendo year y quarter)
df = df[[
    "year",
    "quarter",
    "consumo_privado_nacional",
